...
import { MapIcon, CalendarIcon, FuelIcon, UsersIcon, CarIcon, StarIcon, CogIcon, MapPinnedIcon, UserRoundIcon } from "lucide-react"
        ...
        <div className="mx-auto max-w-sm sm:max-w-full py-8 min-h-screen w-full sm:px-52 ">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-start items-start mt-4">
                <div className="w-full sm:w-3/4 sm:min-h-[600px] shadow-md shadow-slate-400 dark:shadow-zinc-600 p-4 rounded-lg dark:bg-zinc-900">
                    <h1 className="text-3xl dark:text-white/90 text-black mb-4">Vehicle Details</h1>
                    ...
                    <div className="mt-6">
                        ...
                        <h3 className="text-lg sm:text-2xl font-semibold mb-2 dark:text-white/90">Description</h3>
                    ...
                    <div className="mt-8 ">
                        <h1 className="text-lg sm:text-3xl font-semibold mb-2 dark:text-white/90">Booking Information</h1>
                        <div className="mt-4">
                            ...
                            <h1 className="mt-1 font-semibold sm:text-2xl text-md text-black dark:text-white/80">{vehicle.pricePerDay}Tk / day</h1>
                            <div className="flex items-center mb-4 mt-2">
                                ...
                                <StarIcon className="text-yellow-400 mr-1" />
                                <StarIcon className="text-yellow-400 mr-1" />
                                <span className="ml-2 text-sm text-muted-foreground dark:text-white/60">(48 reviews)</span>
                            </div>
                            <div className="mt-2 sm:mt-4 flex flex-col sm:flex-row  gap-4">
                                <div>
                                    {!booked ? (
                                        <button onClick={() => setIsOpen(true)} className="btn border-none bg-blue-700 text-white hover:bg-blue-500">
                                            Book Now
                                        </button>
                                    ) : (
                                        <button className="btn bg-slate-500 dark:text-white/60" disabled>
                                            Already Booked
                                        </button>
                                    )}
                                    {isOpen && !booked && (
